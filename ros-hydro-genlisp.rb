...
class RosHydroGenlisp < Formula
  homepage 'http://www.ros.org/wiki/roslisp'
  url 'https://github.com/ros-gbp/genlisp-release.git', :tag => 'release/hydro/genlisp/0.4.12-0'
  version '0.4.12-0'

  # source repos often contain more than one package... not sure if we can handle this
  #head 'https://github.com/ros-gbp/genlisp-release.git', :branch => 'hydro-devel'
