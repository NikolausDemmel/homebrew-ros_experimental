...
class RosHydroGenpy < Formula
  homepage ''
  url 'https://github.com/ros-gbp/genpy-release.git', :tag => 'release/hydro/genpy/0.4.16-0'
  version '0.4.16-0'

  # source repos often contain more than one package... not sure if we can handle this
  #head 'https://github.com/ros-gbp/genpy-release.git', :branch => 'hydro-devel'
