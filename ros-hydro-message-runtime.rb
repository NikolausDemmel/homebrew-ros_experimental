...
class RosHydroMessageRuntime < Formula
  homepage 'http://ros.org/wiki/message_runtime'
  url 'https://github.com/ros-gbp/message_runtime-release.git', :tag => 'release/hydro/message_runtime/0.4.12-0'
  version '0.4.12-0'

  # source repos often contain more than one package... not sure if we can handle this
  #head 'https://github.com/ros-gbp/message_runtime-release.git', :branch => 'hydro-devel'
  ...
  depends_on "ros-hydro-roscpp-traits"
